...
class TestFinalCorrectness(unittest.TestCase):
    ...
    def test_basic_symbolic(self):
        ...
        self.assertEqual(eval_str(self.calc, "10a*c", mode="num"), "1,00000")

    def test_numerical_power(self):
        self.assertEqual(eval_str(self.calc, "b^a", mode="num"), group_characters(str(100 ** 10)))
        self.assertEqual(eval_str(self.calc, "c^a", mode="num"), group_characters(str(1000 ** 10)))

    def test_hyper_power(self):
        self.assertEqual(eval_str(self.calc, "a^b", mode="num"), group_characters(str(10 ** 100)))
