...
from .graph_logic import definition_edges as _definition_edges
from .graph_logic import graph_has_cycle
...
class DependencyGraphManager:
    ...
    def has_cycle(self) -> bool:
        return graph_has_cycle(self.node_definitions)

    def definition_edges(self):
        return _definition_edges(self.node_definitions, self.dependencies)
